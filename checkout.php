...
if(isset($_POST['order_btn'])){
   ...
   $detail_query = mysqli_query($conn, "INSERT INTO `orders`(user_id	, name, email, number,  method, city, street, state,  pin_code, total_products, total_price, placed_on) VALUES('$user_id','$name','$email','$number','$method','$city','$street','$state','$pin_code','$total_product','$price_total','$placed_on')") or die('query failed');
